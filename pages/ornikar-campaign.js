...
import { getProjectInitialStateByKey, ADVERTISING_KEY } from '../src/utils/project'
...
const Page = ({ url }) => (
  <div className='generic-text'>
    <Head>
      ...
      <title>Mathilde SERRA - Ornikar Campaign | Digital Print</title>

      <meta name="description" content="Conception of an advertising campaign for the first digital online driving license training in France." />
      ...
      <meta property="og:title" content="Mathilde SERRA - Ornikar Campaign | Digital Print" />
      ...
      <meta property="og:description" content="Conception of an advertising campaign for the first digital online driving license training in France." />
      <meta property="og:locale" content="fr_FR" />

      <meta name="twitter:card" content="summary" />
      <meta name="twitter:site" content="@Mathilde__serra" />
      <meta name="twitter:title" content="Mathilde SERRA - Ornikar Campaign | Digital Print" />
      <meta name="twitter:description" content="Conception of an advertising campaign for the first digital online driving license training in France." />
    ...
    `}</style>
    <App initialState={getProjectInitialStateByKey(ADVERTISING_KEY, get(url, 'query.notransition'))} />
  </div>
)
